...
namespace ChessGame
{
    public class ChessGameplay
    {
        ...
        private void PutChessmans()
        {
            ...
            PutNewChessman('b', 1, new Horse(Board, Color.White));
            PutNewChessman('c', 1, new Bishop(Board, Color.White));
            PutNewChessman('d', 1, new Queen(Board, Color.White));
            PutNewChessman('e', 1, new King(Board, Color.White));
            PutNewChessman('f', 1, new Bishop(Board, Color.White));
            PutNewChessman('g', 1, new Horse(Board, Color.White));
            PutNewChessman('h', 1, new Tower(Board, Color.White));
            PutNewChessman('a', 2, new Pawn(Board, Color.White));
            PutNewChessman('b', 2, new Pawn(Board, Color.White));
            PutNewChessman('c', 2, new Pawn(Board, Color.White));
            PutNewChessman('d', 2, new Pawn(Board, Color.White));
            PutNewChessman('e', 2, new Pawn(Board, Color.White));
            PutNewChessman('f', 2, new Pawn(Board, Color.White));
            PutNewChessman('g', 2, new Pawn(Board, Color.White));
            PutNewChessman('h', 2, new Pawn(Board, Color.White));

            PutNewChessman('a', 8, new Tower(Board, Color.Black));
            PutNewChessman('b', 8, new Horse(Board, Color.Black));
            PutNewChessman('c', 8, new Bishop(Board, Color.Black));
            PutNewChessman('d', 8, new Queen(Board, Color.Black));
            PutNewChessman('e', 8, new King(Board, Color.Black));
            PutNewChessman('f', 8, new Bishop(Board, Color.Black));
            PutNewChessman('g', 8, new Horse(Board, Color.Black));
            PutNewChessman('h', 8, new Tower(Board, Color.Black));
            PutNewChessman('a', 7, new Pawn(Board, Color.Black));
            PutNewChessman('b', 7, new Pawn(Board, Color.Black));
            PutNewChessman('c', 7, new Pawn(Board, Color.Black));
            PutNewChessman('d', 7, new Pawn(Board, Color.Black));
            PutNewChessman('e', 7, new Pawn(Board, Color.Black));
            PutNewChessman('f', 7, new Pawn(Board, Color.Black));
            PutNewChessman('g', 7, new Pawn(Board, Color.Black));
            PutNewChessman('h', 7, new Pawn(Board, Color.Black));
        }
